...
const Footer: React.FC = () => {
  return (
    <div className='flex flex-col sm:flex-row items-center justify-center gap-12 sm:justify-between lg:justify-around w-full px-2 py-4 lg:py-12 mt-8 bg-black text-[#fffc] relative left-0 bottom-0'>
      ...
      <div className="flex flex-col items-center justify-start gap-2 sm:gap-5">
        ...
        <p className="w-full text-[8px] lg:text-[16px] text-start whitespace-nowrap cursor-pointer ">Home Designing</p>
      </div>
