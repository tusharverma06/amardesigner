...
const DesignCard: React.FC<DesignCardProps> = ({ thumbnail, title, noOfDesigns }) => {
  return (
    <Link to={`/design-ideas/${title}`} className='flex flex-col items-center justify-between w-11/12 max-w-md gap-3 pb-4 mx-auto rounded-lg shadow-md sm:w-[45%] lg:w-[30%] drop-shadow-sm'>
